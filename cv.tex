...
\simpleheader{headercolour}{Théo}{HUET}{Étudiant en Master de physique théorique}{white}
...
\section*{Curriculum}
\begin{tabular}{r| p{0.5\textwidth} c}
    \cvevent{2021--2024}{Double Licence mention Mathématiques et Physique}{CY Cergy Paris Université}{Cergy-Pontoise (95) 
    \color{cvred}}{Mention Assez Bien. \lorem}{disney.png} \\ %avec S2 CUPGE MP
    \cvevent{2021}{Baccalauréat général spécialité Mathématiques - Physique}{Lycée agricole et horticole}{Saint-Germain-en-Laye (78) \color{cvred}}{Option Maths experts, Mention assez bien  \lorem}{medal.jpeg} \\
\end{tabular}
\vspace{3em}
